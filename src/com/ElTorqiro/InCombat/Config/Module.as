...
function CreateIcon() : Void {
	...
	g_icon = this.attachMovie("com.ElTorqiro.InCombat.Config.Icon", "m_Icon", this.getNextHighestDepth() );
	...
	g_icon.onMousePress = function(buttonID) {
		...
		// right click, toggle hud enabled/disabled
			...
			_root["eltorqiro_incombat\\hud"].g_HUD.hudEnabled = !_root["eltorqiro_incombat\\hud"].g_HUD.hudEnabled;
		}
...
function CreateConfigWindow() : Void {
	...
	g_configWindow = WinComp(attachMovie( "com.ElTorqiro.InCombat.Config.WindowComponent", "m_ConfigWindow", getNextHighestDepth() ));
	...
	g_configWindow.SetContent( "com.ElTorqiro.InCombat.Config.WindowContent" );
